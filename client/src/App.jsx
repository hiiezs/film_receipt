...
return;
  ...
  if (screen === "loading") return (
    <div style={{ minHeight: "100vh", width: "100%", boxSizing: "border-box", background: "#1a1a1a", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", fontFamily: "monospace", color: "#fff" }}>
      <div style={{ fontSize: isMobile ? 44 : 64, marginBottom: 20, animation: "spin 1.2s linear infinite" }}>🎬</div>
      <div style={{ fontSize: isMobile ? 10 : 13, letterSpacing: 4, color: "#555", textTransform: "uppercase", marginBottom: 8 }}>{loadingMsg}</div>
      <div style={{ fontSize: isMobile ? 13 : 18, color: selectedMood?.color || "#FFD700" }}>{selectedMood?.emoji} {selectedMood?.label}</div>
  ...
  // ── MOVIES ───────────────────────────────────────────────────────────────────
  return (
    <div style={{ minHeight: "100vh", width: "100%", boxSizing: "border-box", background: "#f5f0e8", display: "flex", flexDirection: "column", alignItems: "center", padding: isMobile ? "24px 16px 52px" : "40px 48px 80px", backgroundImage: "radial-gradient(circle at 50% 0%,rgba(200,0,0,0.05) 0%,transparent 60%)" }}>
      {/* Top bar */}
